...
from deepspeech_openvino.utils.alphabet import CtcdecoderAlphabet
...
class CtcnumpyBeamSearchDecoder:
    ...
    def decode(self, probs):
        output, scores, timesteps, out_seq_len = self.decoder_state.decode(
            probs[np.newaxis]
        )
        ...
        return [
            dict(
                ...
                text=self.alphabet.decode(
                    output[0, res_idx, : out_seq_len[0, res_idx]]
                ),
